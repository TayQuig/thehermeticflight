...
| 4 | Validate smoke-test with live credentials | `blocked` | GA4_PROPERTY_ID in .env is wrong (has client_id, needs numeric property ID from Analytics UI → Admin → Property Settings). |
